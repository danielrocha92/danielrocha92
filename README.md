...
- <img alt="GIF" src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/gandalf_parrot.gif" width="20px" /> Estou *aprendendo* ☁ **Nuvem** em **SPLUNK>** 🪝 **Hooks** em ⚛️ **ReactJs.** 💪,&nbsp;<img alt="GIF" src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/headbang.gif" width="20px" />*pretendo colaborar* em **projetos** **python**&nbsp;🐍 e <img alt="GIF" src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/hmm.gif" width="20px" /> e *procurando* *ajuda* com minha **EchoDot.** 🌐
